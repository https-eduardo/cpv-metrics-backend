...
export interface ApiClienteCliente extends Schema.CollectionType {
  ...
  attributes: {
    ...
    classificacao: Attribute.Enumeration<['A', 'B', 'C', 'S']> &
      Attribute.Required;
    endereco: Attribute.Component<'cliente.endereco'> & Attribute.Required;
    contratos: Attribute.Relation<
      'api::cliente.cliente',
      'oneToMany',
...
export interface ApiContratoContrato extends Schema.CollectionType {
  ...
  attributes: {
    ...
    mensalidade: Attribute.Decimal & Attribute.Required;
    ltv: Attribute.Decimal & Attribute.DefaultTo<0>;
